    ...
    public class RiotApiManager
    {
        ...
        public async Task<bool> AcceptGame()
        {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function:AcceptGame"  );
            }
            return false;
        }
        ...
        public async Task<bool> DeclineGame()
        {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function:DeclineGame");
            }
            return false;
        }
        ...
        public async Task<bool> NextGame()
        {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function:NextGame" );
            }
            return false;
        }
        ...
        public async Task<bool> SearchGame()
        {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function:SearchGame" );
            }
            return false;
        }
        ...
        public async Task<SummonerInfo> GetSummonerInfo(string summonerid = "")
        {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function:GetSummonerInfo" );
            }
        ...
        public  async   Task<SummonerInfo>  GetSummonerInfoByName(string player_name = "")
        {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function:GetSummonerInfoByName" );
            }
            return default(SummonerInfo);
        }
        ...
        public async Task<ProfileSkin> GetProfileSkin()
        {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function:GetProfileSkin"  );
            }
        ...
        public async Task<byte[]> DownloadIcon(Consture.gamedata_resources_type type, long id)
        {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function:DownloadIcon" );
            }
            return null;
        }
        ...
        public async Task<Consture.client_status> GetClientStatus()
        {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function: GetClientStatus" );
            }
            return client_status.Error;
        }
        ...
        public async Task<bool> SetLockChamp(int champ_id, bool completed)
        {
            try
            {
                using (HttpClient client = CreateHttpClient())
                {
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        ...
                        request.Content = new StringContent(JsonConvert.SerializeObject(champ), Encoding.UTF8, "application/json");
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function: SetLockChamp");
            }
            return false;
        }
        ...
        public async Task<bool> BenchChamp(int champ_id)
        {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function:BenchChamp" );
            }
            return false;
        }
        ...
        public async Task<ChampSelectSession> GetTeamSessions()
        {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function: GetTeamSessions");
            }
            return default(ChampSelectSession);
        }
        ...
        public async Task<Rankdatas> GetRankdatasForPuuid(string puuid = "")
        {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function: GetRankdatasForPuuid"  );
            }
            return default(Rankdatas);
        }
        ...
        public async Task<HistoryMatchDatas> GetHistoryMatchingdatas(string puuid, int min, int max)
        {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function:GetHistoryMatchingdatas exc"  );
            }
        ...
        public async Task<TopChamps> GetTopChamps(string accoutid, int limited)
        {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function:GetTopChamps exc");
            }
        ...
        public async Task<ChampList[]> GetOwnerChamps()
        {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function:GetOwnerChamps exc");
            }
        ...
        public async Task<ChampList[]> GetAllChamps()
        {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function:GetAllChamps exc");
            }
            return default(ChampList[]);
        }
        ...
        public async Task<GameFlow> GetCurrentGameMode()
        {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function:GetCurrentGameMode exc" );
            }
        ...
        {
            Console.WriteLine("run:  function:GetReroller");
            try
            {
                using (HttpClient client = CreateHttpClient())
                {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function:GetReroller exc");
            }
            return false;
        }
        ...
        {
            Console.WriteLine("run:  function:GetPlayerConfig"  );
            try
            {
                using (HttpClient client = CreateHttpClient())
                {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function: GetPlayerConfig exc"  );
            }
            return default(PlayerConfig);
        }
        public  async   void SetPlayerConfig(PlayerConfig   config)
        {
            Console.WriteLine("run:  function: SetPlayerConfig in");
            try
            {
                using (HttpClient client = CreateHttpClient())
                {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function: SetPlayerConfig exc" );
            }
            return ;
        }
        ...
        {
            Console.WriteLine("run:  function: GetGameVersion1");
            try
            {
                using (HttpClient client = CreateHttpClient())
                {
            ...
            catch (HttpRequestException ex)
            {
                ...
                Console.WriteLine("HTTP请求异常: " + ex.Message + " function: GetGameVersion1" );
            }
